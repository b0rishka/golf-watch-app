...
class CourseRepository
    ...
    constructor(
        ...
        fun observeCourses(): Flow<List<CourseOverview>> = dao.observeAll().map { it.map(CourseEntity::toOverview) }
...
private fun CourseEntity.toOverview() =
    CourseOverview(
        id = id,
        osmType = osmType,
        name = name,
...
private fun CourseDto.toEntity() =
    CourseEntity(
        id = id,
        osmType = osmType,
        name = name,
